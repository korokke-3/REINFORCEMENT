...
output_dir = '/home/exhibition-spakona/Desktop/REINFORCEMENT/true_explosive_jump_eval'
...
env = gym.wrappers.RecordVideo(
    ...
    name_prefix='true_explosive_jump_policy',
)
...
ckpt_path = "/home/exhibition-spakona/Desktop/REINFORCEMENT/go2_single_leg/logs/rsl_rl/2026-08-25_02-41-06/model_999.pt"
...
print("\n" + "="*80)
print("=== EVALUATION OF TRUE SINGLE-LEG EXPLOSIVE JUMP RL POLICY ===")
print("="*80)
...
for step in range(200):
    ...
    status = "★★★ TRUE EXPLOSIVE JUMP (IN AIR) ★★★" if is_airborne else "Pushed Ground"
    if is_done:
        status = "RESET"
...
print("\n" + "="*80)
print(f"=== TRUE EXPLOSIVE JUMP EVALUATION RESULTS ===")
...
# GIF生成
video_path = f"{output_dir}/true_explosive_jump_policy-step-0.mp4"

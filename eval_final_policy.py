...
output_dir = '/home/exhibition-spakona/Desktop/REINFORCEMENT/final_single_leg_eval'
...
env = gym.wrappers.RecordVideo(
    ...
    name_prefix='final_single_leg_policy',
)
...
ckpt_path = "/home/exhibition-spakona/Desktop/REINFORCEMENT/go2_single_leg/logs/rsl_rl/2026-08-24_02-47-30/model_999.pt"
...
print("\n" + "="*70)
print("=== EVALUATION OF FINAL SINGLE-LEG RL POLICY (ITERATION 1000) ===")
print("="*70)
...
for step in range(200):
    ...
    status = "ALIVE (Single-Leg Standing)" if not is_done else "RESET"
    
    print(f"Step {step:03d} (t={step*0.02:.2f}s) | Body_Z={root_pos[2]*100:5.1f}cm | Foot_Z={rr_foot[2]*100:+5.1f}cm | Vz={root_vel[2]:+5.2f}m/s | [{status}]")
...
print(f"Total Resets Occurred: {resets}")
...
# GIF生成
video_path = f"{output_dir}/final_single_leg_policy-step-0.mp4"
if os.path.exists(video_path):
    ...
    cap.release()
    if frames:
        gif_path = f"{output_dir}/final_single_leg_policy.gif"

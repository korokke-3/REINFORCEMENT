...
parser = argparse.ArgumentParser(description="Record Go2 Single-Leg Video")
parser.add_argument("--task", type=str, default="Isaac-Velocity-Rough-Unitree-Go2-SingleLeg-Play-v0", help="Task name")
...
def main():
    ...
    if videos:
        ...
        final_mp4 = os.path.abspath(os.path.join(os.path.dirname(__file__), "logs", "go2_single_leg.mp4"))

"""
Unitree Go2 後足2本立ち歩行 動作録画スクリプト (Headless MP4出力)
"""
...
parser = argparse.ArgumentParser(description="Record Go2 Bipedal Video to MP4")
...
def main():
    ...
    if videos:
        ...
        final_mp4 = os.path.abspath(os.path.join(os.path.dirname(__file__), "logs", "go2_bipedal.mp4"))

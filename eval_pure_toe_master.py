...
output_dir = '/home/exhibition-spakona/Desktop/REINFORCEMENT/pure_toe_master_eval'
...
ckpt_path = "/home/exhibition-spakona/Desktop/REINFORCEMENT/go2_single_leg/logs/rsl_rl/2026-08-26_08-50-34/model_2499.pt"
...
print("\n" + "="*85)
print("=== EVALUATION OF PURE TOE (ZERO KNEE CONTACT) JUMP MASTER POLICY ===")
print("="*85)
...
for step in range(250):
    ...
    status = "★★★ PURE TOE JUMP IN AIR ★★★" if is_airborne else "Toe Contact Push"
    if is_done:
        status = "RESET"
        
    print(f"Step {step:03d} (t={step*0.02:.2f}s) | Body_Z={root_pos[2]*100:5.1f}cm | Vz={root_vel[2]:+5.2f}m/s | Foot_Z={rr_foot[2]*100:+5.1f}cm | Knee_Z={rr_calf[2]*100:+5.1f}cm | Other_Min_Z={min_other*100:+5.1f}cm | [{status}]")
...
print("\n" + "="*85)
print(f"=== PURE TOE MASTER EVALUATION RESULTS ===")
...
# GIF生成
video_path = f"{output_dir}/pure_toe_master-step-0.mp4"
if os.path.exists(video_path):
    ...
    cap.release()
    if frames:
        gif_path = f"{output_dir}/pure_toe_master.gif"

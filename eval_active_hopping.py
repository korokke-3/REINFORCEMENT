...
output_dir = '/home/exhibition-spakona/Desktop/REINFORCEMENT/active_hopping_eval'
...
env = gym.wrappers.RecordVideo(
    ...
    name_prefix='active_hopping_policy',
)
...
ckpt_path = "/home/exhibition-spakona/Desktop/REINFORCEMENT/go2_single_leg/logs/rsl_rl/2026-08-24_11-58-03/model_999.pt"
...
print("\n" + "="*70)
print("=== EVALUATION OF ACTIVE CONTINUOUS HOPPING RL POLICY ===")
print("="*70)
...
for step in range(200):
    ...
    status = "★ AIRBORNE HOP ★" if is_airborne else "Grounded Support"
    if is_done:
        status = "RESET"
...
print("\n" + "="*70)
print(f"=== ACTIVE HOPPING EVALUATION RESULTS ===")
...
# GIF生成
video_path = f"{output_dir}/active_hopping_policy-step-0.mp4"
if os.path.exists(video_path):
    ...
    cap.release()
    if frames:
        gif_path = f"{output_dir}/active_hopping_policy.gif"

...
output_dir = '/home/exhibition-spakona/Desktop/REINFORCEMENT/raibert_pure_toe_eval'
...
print("\n" + "="*85)
print("=== EVALUATION OF RAIBERT HOPPER PURE TOE JUMP POLICY ===")
print("="*85)
...
for step in range(250):
    ...
    status = "★★★ RAIBERT PURE TOE AIR ★★★" if is_airborne else "Toe Rebound Push"
    if is_done:
        status = "RESET"
...
print("\n" + "="*85)
print(f"=== RAIBERT PURE TOE EVALUATION RESULTS ===")
...
# GIF生成
video_path = f"{output_dir}/raibert_pure_toe-step-0.mp4"
if os.path.exists(video_path):
    ...
    cap.release()
    if frames:
        gif_path = f"{output_dir}/raibert_pure_toe.gif"

...
output_dir = '/home/exhibition-spakona/Desktop/REINFORCEMENT/continuous_jump_7400iter_eval'
...
env = gym.wrappers.RecordVideo(
    ...
    name_prefix='continuous_jump_7400iter',
)
...
ckpt_path = "/home/exhibition-spakona/Desktop/REINFORCEMENT/go2_single_leg/logs/rsl_rl/2026-08-26_02-19-15/model_7400.pt"
...
print("\n" + "="*85)
print("=== EVALUATION OF 7400-ITERATION CONTINUOUS SINGLE-LEG JUMP POLICY ===")
print("="*85)
...
for step in range(250):
    ...
    status = "★★★ 7400-ITER JUMP IN AIR ★★★" if is_airborne else "Touchdown & Push"
    if is_done:
        status = "RESET"
...
print("\n" + "="*85)
print(f"=== 7400-ITERATION CONTINUOUS JUMP EVALUATION RESULTS ===")
...
# GIF生成
video_path = f"{output_dir}/continuous_jump_7400iter-step-0.mp4"
if os.path.exists(video_path):
    ...
    cap.release()
    if frames:
        gif_path = f"{output_dir}/continuous_jump_7400iter.gif"
